...
export default function Customers() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "VIP":
        return <Badge className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-primary">VIP</Badge>;
      case "Regular":
        return <Badge variant="outline" className="border-blue-500 text-blue-600">Regular</Badge>;
      case "New":
        return <Badge variant="outline" className="border-green-500 text-green-600">New</Badge>;
      default:
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <h2 className="text-2xl md:text-3xl font-bold text-primary">Customer Management</h2>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-3 border-t">
                  ...
                  <Button size="sm" className="flex-1">New Sale</Button>
                </div>
              </div>
            </CardContent>
          </Card>
